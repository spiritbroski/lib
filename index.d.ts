...
import { Cookie } from '@spiritbro1/qwik-city/middleware/request-handler';
import { CookieOptions } from '@spiritbro1/qwik-city/middleware/request-handler';
import { CookieValue } from '@spiritbro1/qwik-city/middleware/request-handler';
import { DeferReturn } from '@spiritbro1/qwik-city/middleware/request-handler';
import { JSXNode } from '@builder.io/qwik';
import { QRL } from '@builder.io/qwik';
import { QwikIntrinsicElements } from '@builder.io/qwik';
import { QwikJSX } from '@builder.io/qwik';
import { RequestEvent } from '@spiritbro1/qwik-city/middleware/request-handler';
import { RequestEventAction } from '@spiritbro1/qwik-city/middleware/request-handler';
import { RequestEventCommon } from '@spiritbro1/qwik-city/middleware/request-handler';
import { RequestEventLoader } from '@spiritbro1/qwik-city/middleware/request-handler';
import { RequestHandler } from '@spiritbro1/qwik-city/middleware/request-handler';
import type { ResolveSyncValue } from '@spiritbro1/qwik-city/middleware/request-handler';
...
export declare interface ActionStore<RETURN, INPUT, OPTIONAL extends boolean = true> {
     ...
     *
     * ```tsx
     * import {action$, Form} from '@spiritbro1/qwik-city';
     *
