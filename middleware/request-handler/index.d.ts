import type { Action } from '@spiritbro1/qwik-city';
import type { _deserializeData } from '@builder.io/qwik';
import type { FailReturn } from '@spiritbro1/qwik-city';
import type { Loader } from '@spiritbro1/qwik-city';
import type { QwikCityPlan } from '@spiritbro1/qwik-city';
import type { Render } from '@builder.io/qwik/server';
import type { RenderOptions } from '@builder.io/qwik/server';
import type { RequestEvent as RequestEvent_2 } from '@spiritbro1/qwik-city';
import type { RequestHandler as RequestHandler_2 } from '@spiritbro1/qwik-city/middleware/request-handler';
import type { ResolveSyncValue as ResolveSyncValue_2 } from '@spiritbro1/qwik-city/middleware/request-handler';
